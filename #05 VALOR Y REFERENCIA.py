...
#Tipos de dato por valor ### los tipos de datos primitivos como un int, str, float suelen ser por valor
...
#Tipos de dato por referencia ### en python , originalmente son los tipos de dato que no son primitivos, list, tuple, dict
